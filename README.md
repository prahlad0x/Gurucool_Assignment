...
### Installation
1. Clone the repository. `git clone https://github.com/prahlad0x/Gurucool_Assignment`
2. Open the file name Server in terminal
...
- Method: GET
- Parameters:
  - `shortUrl` (string): The short URL generated by the app in `req.body object`.
